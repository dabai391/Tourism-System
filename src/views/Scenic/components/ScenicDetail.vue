  ...
  <div class="scenic-detail-container">
    ...
    <div class="locationevaluate">
      ...
      <div class="evaluation-scroll">
        <div class="evaluation-item" v-for="(item, index) in evaluations" :key="index">
          <div class="user-info">
...
.scenic-detail-container {
  ...
  .scenic-vr {
    ...
    border-radius: 5px;
    background: url('@/assets/img/vr-bg.png') no-repeat center center/cover;
    ...
    &::before {
      ...
      width: 100%;
      height: 75px;
      // background: url('@/assets/img/vr-icon.png') no-repeat center center/cover;
      background: #007bff;
    }
  }
